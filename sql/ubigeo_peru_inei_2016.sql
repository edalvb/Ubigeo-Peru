...
CREATE SCHEMA IF NOT EXISTS `ubigeo_peru` DEFAULT CHARACTER SET utf8mb4 ;
USE `ubigeo_peru` ;
...
CREATE TABLE IF NOT EXISTS `ubigeo_peru`.`ubigeo_peru_departments` (
...
--
CREATE TABLE IF NOT EXISTS `ubigeo_peru`.`ubigeo_peru_provinces` (
...
--
CREATE TABLE IF NOT EXISTS `ubigeo_peru`.`ubigeo_peru_districts` (
  `id` VARCHAR(6) NOT NULL,
  `name` VARCHAR(45) NOT NULL,
  `province_id` VARCHAR(4) NOT NULL,
  `department_id` VARCHAR(2) NOT NULL,
  PRIMARY KEY (`id`),
  INDEX `departamento_idx` (`department_id` ASC),
  INDEX `provincia_fk_idx` (`province_id` ASC),
  CONSTRAINT `departamento_fk`
    FOREIGN KEY (`department_id`)
    REFERENCES `ubigeo_peru`.`ubigeo_peru_departments` (`id`)
    ON DELETE CASCADE
    ON UPDATE CASCADE,
  CONSTRAINT `provincia_fk`
    FOREIGN KEY (`province_id`)
    REFERENCES `ubigeo_peru`.`ubigeo_peru_provinces` (`id`)
    ON DELETE CASCADE
    ON UPDATE CASCADE)
ENGINE = InnoDB
DEFAULT CHARACTER SET = utf8mb4;
